...
* Have QMK installed
* Add the keymap files in this repository to a new folder `qmk_firmware/keyboards/sofle_choc/keymaps/my-map` and compile: `qmk compile -kb sofle_choc -km my-map [-e CONVERT_TO=elite_pi]`
* Flash each halve of the keyboard with the TRRS connector being disconnected: `qmk flash -kb sofle_choc -km my-map` or via USB file drop-off, depending on which chip is used.
 ...
 * |--------+--------+------+------+------+------|                    |------+------+------+------+------+------|
 * |        | Spd-   | Val- | Sat- | Hue- |Mode- |-------.    ,-------|      | VolDn| Mute | VolUp|      |      |
 * |--------+--------+------+------+------+------|       |    |       |------+------+------+------+------+------|
